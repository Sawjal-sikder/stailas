    ...
    <div className="px-4 sm:px-8 md:px-16 lg:px-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 pt-10">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          <Image src={WomanImage1} alt="WomanImage1" className="w-full max-w-[200px]" />
          <p className="font-inter text-md text-gray-700">
            Finally a stylist who gets me—without making me feel judged.
          </p>
        </div>
        <div className="flex flex-col items-center text-center space-y-4">
          <Image src={WomanImage2} alt="WomanImage2" className="w-full max-w-[200px]" />
          <p className="font-inter text-md text-gray-700">
            It helped me see I already have a signature look. I  just needed a mirror.
          </p>
        </div>
        <div className="flex flex-col items-center text-center space-y-4">
          <Image src={WomanImage3} alt="WomanImage3" className="w-full max-w-[200px]" />
          <p className="font-inter text-md text-gray-700">
            Shopping is smarter now. I know what flatters me  and what to skip.”
          </p>
        </div>
        <div className="flex flex-col items-center text-center space-y-4">
          <Image src={WomanImage4} alt="WomanImage4" className="w-full max-w-[200px]" />
          <p className="font-inter text-md text-gray-700">
